...
;;; lisp-treemacs.el --- Treemacs config (neo-tree–like) -*- lexical-binding: t -*-

;; Version: 1.0
;; Package-Requires: ((emacs "30"))

;;; Commentary:
;; Treemacs configuration with behavior similar to neo-tree from Neovim:
;; - toggle file tree with one key
...
(use-package treemacs
  ...
  :init
  ;; toggle tree
  ;(global-set-key (kbd "C-n") #'my/treemacs-toggle)
